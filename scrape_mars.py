...
def mars_news_scrape():
    ...
    nana_news_paragraph = Nasa_soup.find('div', class_='article_teaser_body').textmars_data['nasa_news_paragraph'] = nasa_news_paragraph
...
def img_scrape():
    ...
    jplNasa_url = 'https://www.nasa.gov/spaceimages/?search=&category=Mars'
